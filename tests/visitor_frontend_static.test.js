...

{
  ...
  const photoStateCss = sectionBetween(kioskCss, '.cameraFrame[data-photo-state="review"] .faceGuide', '.cameraActions');
  ...
  assert.match(photoStateCss, /display:\s*none/, 'Photo guide should hide in captured review state');
