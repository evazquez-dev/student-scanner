(function () {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      /* While Scanner Configuration is open, make the legacy kiosk modal guard read as active without showing it. */
      body.scanner-config-menu-open #locModal{display:block!important;visibility:hidden!important;pointer-events:none!important}
  ...
  function closeMenu() {
    ...
    document.body?.classList.remove('scanner-config-menu-open');
    ACTIVE_CONFIG_CODE = '';
  ...
  function showModalHtml(html) {
    ...
    document.body?.classList.add('scanner-config-menu-open');
  }
